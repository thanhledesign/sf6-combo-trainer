  ...
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        ...
        description: 'Street Fighter 6 learning tool focused on counterplay education',
        theme_color: '#1f2937',
      ...
      workbox: {
        ...
        maximumFileSizeToCacheInBytes: 20 * 1024 * 1024, // 20MB for videos
        runtimeCaching: [
          {
